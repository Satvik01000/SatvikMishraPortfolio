    ...
    return (
        <Box sx={{ mt: 2, mb: 2 }}>
            ...
            <ImageList sx={{ display: "flex", flexDirection: "row", justifyContent: "flex-start", alignItems: "flex-start" }}>
                <ImageListItem sx={{ width: 28, height: 20, mt:0.3, mx: 2, transition: "opacity 0.3s", ":hover": { opacity: 0.7 } }} component="a" href="https://leetcode.com/u/Satvik0100/" target="_blank" rel="noopener noreferrer">
